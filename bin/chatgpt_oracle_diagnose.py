...
SIGNATURE_RULES: tuple[tuple[str, str, str], ...] = (
    ...
    ("Cloudflare challenge", PRE_SUBMIT_UI, "cloudflare-challenge-detected"),
    ("Verify you are human", PRE_SUBMIT_UI, "cloudflare-challenge-detected"),
    ("Just a moment...", PRE_SUBMIT_UI, "cloudflare-challenge-detected"),
    ("reached the Pro limit", PRE_SUBMIT_UI, "pro-quota-limit-reached"),
    ("Pro limit reached", PRE_SUBMIT_UI, "pro-quota-limit-reached"),
    ("usage limit for Pro", PRE_SUBMIT_UI, "pro-quota-limit-reached"),
    ("Session appears logged out", PRE_SUBMIT_UI, "auth-session-expired"),
    ("redirected to auth/login", PRE_SUBMIT_UI, "auth-session-expired"),
    ("No valid session cookies found", PRE_SUBMIT_UI, "auth-session-expired"),
