    ...
    *,
    ...
    manifest: dict[str, Any] = {
        ...
        "transport": {
            ...
            "oracle-deep-research-attachment-only": "deep-research-attachment-only",
    ...
    if contract["route"] in {"oracle-pro-attachment-only", "oracle-deep-research-attachment-only"}:
