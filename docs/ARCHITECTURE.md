...
Internal `codexpro-*` state schemas and receipt IDs remain stable for backward-compatible
recovery and rollback. All active web delegation uses the unified Oracle + DevSpace stack.
